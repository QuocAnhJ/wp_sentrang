...
function spa_and_salon_footer_credit(){
   ...
   // $text .= '</span>';
   // $text .= '<span class="by">' . sprintf( esc_html( $spa_and_salon_social_info ) ) . ' ';
   // $text .= '<span class="by">';
   // if( $social_links ) {
     //   $spa_and_salon_button_url_fb = get_theme_mod( 'spa_and_salon_button_url_fb');
     //   if ($spa_and_salon_button_url_fb) {
     //       $text .= sprintf('<a href="'. esc_url( __($spa_and_salon_button_url_fb, 'spa-and-salon' ) ) .'".><i class="fa fa-facebook"></i></a>');
       // }
   // }
